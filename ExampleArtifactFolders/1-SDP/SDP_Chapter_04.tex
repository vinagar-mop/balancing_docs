...
The current software plan is to use a combination of touch GFX and cube MX that all have a developer interaction to be able to produce the bugging code and release code.
...
There are non-other development activities needed.