...
{
	\item The SubMode-A submode generalizes the case where the system has to have the requirement integrated properly within the system.
}
...
% #8 is Notes; listed as enumeration \item ...
{
	\item The SubMode-B submode generalizes the case where the system has to have the requirement integrated properly within the system.
}
% #9 is changebar version
{P1}
%%%%% end \ONERQMTV[9] macro
...
% #8 is Notes; listed as enumeration \item ...
{
	\item The SubMode-C submode generalizes the case where the system has to have the requirement integrated properly within the system.
}
% #9 is changebar version
{P1}
%%%%% end \ONERQMTV[9] macro
