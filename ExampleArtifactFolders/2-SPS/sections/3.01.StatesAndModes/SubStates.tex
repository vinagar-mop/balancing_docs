...
{
	\item [Phase 1] The screen must show as described.
}
% #6 is Acceptance
...
{
	\item The SubState-A substate generalizes the case where the system has to have the requirement integrated properly within the system.
}
...
% #8 is Notes; listed as enumeration \item ...
{
	\item The SubState-C substate generalizes the case where the system has to have the requirement integrated properly within the system.
}
% #9 is changebar version
{P1}
%%%%% end \ONERQMTV[9] macro
...
% #8 is Notes; listed as enumeration \item ...
{
	\item The SubState-D substate generalizes the case where the system has to have the requirement integrated properly within the system.
}
% #9 is changebar version
{P1}
%%%%% end \ONERQMTV[9] macro
...
% #8 is Notes; listed as enumeration \item ...
{
	\item The SubState-E substate generalizes the case where the system has to have the requirement integrated properly within the system.
}
% #9 is changebar version
{P1}
%%%%% end \ONERQMTV[9] macro
...
% #8 is Notes; listed as enumeration \item ...
{
	\item The SubState-F substate generalizes the case where the system has to have the requirement integrated properly within the system.
}
% #9 is changebar version
{P1}
%%%%% end \ONERQMTV[9] macro
...
% #8 is Notes; listed as enumeration \item ...
{
	\item The SubState-G substate generalizes the case where the system has to have the requirement integrated properly within the system.
}
% #9 is changebar version
{P1}
%%%%% end \ONERQMTV[9] macro
...
% #8 is Notes; listed as enumeration \item ...
{
	\item The SubState-H substate generalizes the case where the system has to have the requirement integrated properly within the system.
}
% #9 is changebar version
{P1}
%%%%% end \ONERQMTV[9] macro
