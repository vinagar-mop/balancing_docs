...
The segment design is structured to meet the requirements as specified in the following artifacts.
...
\begin{figure}[htbp]
	\centering
			\ifpdf
			\includegraphics[width=6.5in]{../zProjectWideData/images/DFD-0_Image.pdf}
		\else
