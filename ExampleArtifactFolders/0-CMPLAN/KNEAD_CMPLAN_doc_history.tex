%%% SVN stuff
\svnid{$Id: KNEAD_CMPLAN_doc_history.tex 141 2025-07-29 01:14:15Z KneadProject $}
...
\begin{table}[h]
    ...
    \multicolumn{4}{l}{\bfseries Change Record} \\
		...
		\hline
		\hline
			 28 Apr 2024	&	\centering	P1	&	{\raggedright Lewis Collier}	&	Preliminary DRAFT version  \\ \hline
		\hline		
		\hline				
  	\end{tabular}
