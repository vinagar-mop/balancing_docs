%%% SVN stuff
\svnid{$Id: STS_Chapter_04.1.1_TestCaseBase.tex 128 2024-07-14 20:00:16Z KneadProject $}

\subsection{\StsTestCaseID}
\label{loc:Test\StsTestCaseID}
\input{DIDINFO_Snippets/STS/STS_4.x.y.0_DIDINFO.tex}

Test \StsTestSpecID{} case \StsTestCaseID{} is to see if the system turns on.
...
This prerequisite conditions for test \StsTestSpecID{} case \StsTestCaseID{} are that there must need to be at least 5 volts to be applied to the system.
...
This procedure for test \StsTestSpecID{} case \StsTestCaseID{} is not necessary.
...
\input{KNEAD_PreTestInfo.tex}%from $TEXINPUTS; make a local copy and adjust as appropriate.
%
