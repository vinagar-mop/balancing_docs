%%% SVN stuff
\svnid{$Id: STS_Chapter_04.2.1_TestCaseBase.tex 128 2024-07-14 20:00:16Z KneadProject $}

\subsection{\StsTestCaseID}
\label{loc:Test\StsTestCaseID}
\input{DIDINFO_Snippets/STS/STS_4.x.y.0_DIDINFO.tex}

Test \StsTestSpecID{} case \StsTestCaseID{} is the help screen showing up.
...
This prerequisite conditions for test \StsTestSpecID{} case \StsTestCaseID{} are not necessary.
