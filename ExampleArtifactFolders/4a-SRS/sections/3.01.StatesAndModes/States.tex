...
{
	\item The State-1 state generalizes the case where the system has to have the requirement integrated properly within the system.
}
...
% #8 is Notes; listed as enumeration \item ...
{
	\item The State-2 state generalizes the case where the system has to have the requirement integrated properly within the system.
}
% #9 is changebar version
{P1}
%%%%% end \ONERQMTV[9] macro
...
% #8 is Notes; listed as enumeration \item ...
{
	\item The State-3 state generalizes the case where the system has to have the requirement integrated properly within the system.
}
% #9 is changebar version
{P1}
%%%%% end \ONERQMTV[9] macro
