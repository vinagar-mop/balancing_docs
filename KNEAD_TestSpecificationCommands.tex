%%% SVN stuff
\svnid{$Id: KNEAD_TestSpecificationCommands.tex 128 2024-07-14 20:00:16Z KneadProject $}
...
\begin{minipage}[c][][c]{\TestProcIconWidth}\vspace{4pt}\includegraphics{#2}\vspace{4pt}\end{minipage}
...
\ifpdf
\newcommand{\tpStepCLOCK}[1]{\tpStepICONBASE{#1}{MarginIcons/CLOCK_Icon.pdf}}
\newcommand{\tpStepHAND}[1]{\tpStepICONBASE{#1}{MarginIcons/HAND_Icon.pdf}}
\newcommand{\tpStepINFO}[1]{\tpStepICONBASE{#1}{MarginIcons/INFO_Icon.pdf}}
\newcommand{\tpStepKEY}[1]{\tpStepICONBASE{#1}{MarginIcons/KEY_Icon.pdf}}
\newcommand{\tpStepMAGNIFY}[1]{\tpStepICONBASE{#1}{MarginIcons/MAGNIFY_Icon.pdf}}
\newcommand{\tpStepPLAYARROW}[1]{\tpStepICONBASE{#1}{MarginIcons/PLAYARROW_Icon.pdf}}
\newcommand{\tpStepBANG}[1]{\tpStepICONBASE{#1}{MarginIcons/BANG_Icon.pdf}}
\newcommand{\tpStepSHOCK}[1]{\tpStepICONBASE{#1}{MarginIcons/SHOCK_Icon.pdf}}
\newcommand{\tpStepRADIATION}[1]{\tpStepICONBASE{#1}{MarginIcons/RADIATION_Icon.pdf}}
\newcommand{\tpStepREPEAT}[1]{\tpStepICONBASE{#1}{MarginIcons/REPEAT_Icon.pdf}}
\newcommand{\tpStepONOFF}[1]{\tpStepICONBASE{#1}{MarginIcons/ONOFF_Icon.pdf}}
\newcommand{\tpStepFOOTSTEPS}[1]{\tpStepICONBASE{#1}{MarginIcons/FOOTSTEPS_Icon.pdf}}
\newcommand{\tpStepQUESTION}[1]{\tpStepICONBASE{#1}{MarginIcons/QUESTION_Icon.pdf}}
\newcommand{\tpStepBULLSEYE}[1]{\tpStepICONBASE{#1}{MarginIcons/BULLSEYE_Icon.pdf}}
\newcommand{\tpStepFILES}[1]{\tpStepICONBASE{#1}{MarginIcons/FILES_Icon.pdf}}
\else
\newcommand{\tpStepCLOCK}[1]{\tpStepICONBASE{#1}{MarginIcons/CLOCK_Icon.eps}}
\newcommand{\tpStepHAND}[1]{\tpStepICONBASE{#1}{MarginIcons/HAND_Icon.eps}}
\newcommand{\tpStepINFO}[1]{\tpStepICONBASE{#1}{MarginIcons/INFO_Icon.eps}}
\newcommand{\tpStepKEY}[1]{\tpStepICONBASE{#1}{MarginIcons/KEY_Icon.eps}}
\newcommand{\tpStepMAGNIFY}[1]{\tpStepICONBASE{#1}{MarginIcons/MAGNIFY_Icon.eps}}
\newcommand{\tpStepPLAYARROW}[1]{\tpStepICONBASE{#1}{MarginIcons/PLAYARROW_Icon.eps}}
\newcommand{\tpStepBANG}[1]{\tpStepICONBASE{#1}{MarginIcons/BANG_Icon.eps}}
\newcommand{\tpStepSHOCK}[1]{\tpStepICONBASE{#1}{MarginIcons/SHOCK_Icon.eps}}
\newcommand{\tpStepRADIATION}[1]{\tpStepICONBASE{#1}{MarginIcons/RADIATION_Icon.eps}}
\newcommand{\tpStepONOFF}[1]{\tpStepICONBASE{#1}{MarginIcons/ONOFF_Icon.eps}}
\newcommand{\tpStepFOOTSTEPS}[1]{\tpStepICONBASE{#1}{MarginIcons/FOOTSTEPS_Icon.eps}}
\newcommand{\tpStepREPEAT}[1]{\tpStepICONBASE{#1}{MarginIcons/REPEAT_Icon.eps}}
\newcommand{\tpStepQUESTION}[1]{\tpStepICONBASE{#1}{MarginIcons/QUESTION_Icon.eps}}
\newcommand{\tpStepBULLSEYE}[1]{\tpStepICONBASE{#1}{MarginIcons/BULLSEYE_Icon.eps}}
\newcommand{\tpStepFILES}[1]{\tpStepICONBASE{#1}{MarginIcons/FILES_Icon.eps}}
\fi
